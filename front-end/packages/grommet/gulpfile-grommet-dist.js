...
module.exports = function(gulp) {
  ...
  gulp.task('magneto-dist-css', () => {
    return gulp.src('src/scss/magneto/*.scss')
      .pipe(sass({
      ...
      .pipe(gulp.dest('dist/css/magneto'));
  })
  ...
  gulp.task('dist-css', () => {
    ...
    gulp.src('src/scss/magneto/*.scss')
      .pipe(sass({
        includePaths: [path.resolve(__dirname, './node_modules')]
      }))
      .pipe(rename('grommet-magneto.min.css'))
      .pipe(minifyCss())
      .pipe(gulp.dest('dist/'));
